...
l1, = plt.plot(grouped_page_true[0:10].values, label='True', marker='o')
l2, = plt.plot(grouped_page_true[grouped_page_false[0:10].index], label='False', marker='o')
plt.legend(handles=[l1, l2])
plt.tight_layout()
...
plt.legend()
plt.xticks(rotation='vertical')
l1, = plt.plot(grouped_page_false[0:10].values, label='False', marker='o')
l2, = plt.plot(grouped_page_false[grouped_page_true[0:10].index], label='True', marker='o')
plt.legend(handles=[l1, l2])
plt.tight_layout()
